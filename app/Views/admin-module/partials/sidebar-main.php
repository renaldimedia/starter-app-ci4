<aside class="main-sidebar fixed offcanvas shadow" data-toggle='offcanvas'>
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a href="index.html"><i class="icon icon-sailing-boat-water purple-text s-18"></i>Dashboard</a>
                            </li>
                    ...
                    <li class="treeview"><a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="panel-page-products.html"><i class="icon icon-circle-o"></i>All Posts</a>
                            </li>
                            <li><a href="panel-page-products-create.html"><i class="icon icon-add"></i>Add New Post</a>
                            </li>
                            <li><a href="panel-page-products.html"><i class="icon icon-circle-o"></i>Kode Gacha</a>
                            </li>
                        </ul>
                    </li>
